...
public class HiveUI extends Application {
	FileWriter fw = null;
	...
	public void start(Stage primaryStage) throws Exception {
        ...
        txt1.setPromptText("Enter the Hive Querry Here.");
        ...
        btn.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
            	 ...
            	 ObservableList<CharSequence> paragraph = txt1.getParagraphs();
            	    ...
            	    try
            	    {
            	        BufferedWriter bf = new BufferedWriter(new FileWriter(new File("/home/home/Desktop/hivefiles/file1.hql")));
            	        while(iter.hasNext())
            	        {
            	...
            	String Path="/home/home/Desktop/apache-hive-1.2.2-bin/bin/hive -f /home/home/Desktop/hivefiles/file1.hql";
            	try{
